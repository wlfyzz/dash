...
export function Settings() {
  ...
  const confirmUpdate = async () => {
    ...
    try {
      if (updateType === 'account') {
        await updateAccount({id, name, email })
  ...
  const updateAccount = async (data: {id: any, name: string; email: string }) => {
  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8 bg-gray-800 rounded-lg shadow-lg">
      <Tabs defaultValue="account" className="w-full">
        <TabsList className="flex w-full bg-gray-800 p-1 rounded-full mb-6">
          <TabsTrigger value="account" className="flex-1 rounded-full">Account</TabsTrigger>
          <TabsTrigger value="password" className="flex-1 rounded-full">Password</TabsTrigger>
          <TabsTrigger value="avatar" className="flex-1 rounded-full">Avatar</TabsTrigger>
          <TabsTrigger value="delete" className="flex-1 rounded-full">Delete Account</TabsTrigger>
        </TabsList>
        <TabsContent value="account">
          <Card className="bg-gray-800 border-gray-700 rounded-xl overflow-hidden mb-6">
            <CardHeader>
            ...
            <CardFooter>
              <Button variant="secondary" onClick={() => handleUpdate('account')} className="w-full md:w-auto">Save changes</Button>
            </CardFooter>
          </Card>
        </TabsContent>
        <TabsContent value="password">
          <Card className="bg-gray-800 border-gray-700 rounded-xl overflow-hidden mb-6">
            ...
            <CardFooter>
              <Button variant="secondary" onClick={() => handleUpdate('password')} className="w-full md:w-auto">Update password</Button>
            </CardFooter>
          </Card>
        </TabsContent>
          ...
          <Card className="bg-gray-800 border-gray-700 rounded-xl overflow-hidden mb-6">
            ...
            <CardContent className="md:flex md:items-center md:space-x-6">
              <div className="flex flex-col items-center space-y-4 md:w-1/3">
                ...
                <Label htmlFor="avatar" className="cursor-pointer bg-gray-700 text-white py-2 px-4 rounded-md hover:bg-gray-600 transition-colors">
                  Choose file
                  <Input
                    id="avatar"
                    type="file"
            ...
            <CardFooter>
              <Button variant="secondary" onClick={() => handleUpdate('avatar')} disabled={!avatarFile} className="w-full md:w-auto">
                Update Avatar
              </Button>
            </CardFooter>
          </Card>
        ...
        <TabsContent value="delete">
          <Card className="bg-gray-800 border-gray-700 rounded-xl overflow-hidden mb-6">
            ...
            <CardFooter>
              <Button variant="destructive" onClick={() => handleUpdate('delete')} className="w-full md:w-auto">
                Delete Account
              </Button>
            </CardFooter>
          </Card>
      ...
      <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <AlertDialogContent className="bg-gray-800 text-white border-gray-700 rounded-xl">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={confirmUpdate} className="bg-blue-600 text-white hover:bg-blue-500">Confirm</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
        ...
        <AlertDialogContent className="bg-gray-800 text-white border-gray-700 rounded-xl">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="deleteOTP" className="text-white">One-Time Password</Label>
              <Input 
                id="deleteOTP" 
                value={deleteOTP}
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-gray-700 text-white hover:bg-gray-600">Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={confirmDelete} className="bg-red-600 text-white hover:bg-red-500">Delete Account</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </div>
